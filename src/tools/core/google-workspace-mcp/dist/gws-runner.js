 ...
 */
export async function runGwsHelper(service, helper, args) {
        ...
        child.on('close', (exitCode) => {
            ...
            if (actualExitCode === 0) {
                ...
                try {
                    ...
                    resolve({ success: true, data: stdout, exitCode: 0 });
                }
            }
            else {
...
export async function runGws(service, resource, method, options) {
