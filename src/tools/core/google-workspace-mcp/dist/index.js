...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            case 'gmail_list_messages': return await gmailListMessages(args);
            case 'gmail_get_message': return await gmailGetMessage(args);
            case 'gmail_send_message': return await gmailSendMessage(args);
            case 'gmail_trash_message': return await gmailTrashMessage(args);
            case 'tasks_list_tasklists': return await tasksListTaskLists();
            case 'tasks_list_tasks': return await tasksListTasks(args);
            case 'tasks_create_task': return await tasksCreateTask(args);
            case 'tasks_get_task': return await tasksGetTask(args);
            case 'tasks_update_task': return await tasksUpdateTask(args);
            case 'tasks_delete_task': return await tasksDeleteTask(args);
            ...
            case 'calendar_get_event': return await calendarGetEvent(args);
            case 'calendar_delete_event': return await calendarDeleteEvent(args);
            case 'drive_list_files': return await driveListFiles(args);
            case 'drive_get_file_content': return await driveGetFileContent(args);
            case 'drive_create_file': return await driveCreateFile(args);
            case 'drive_update_file': return await driveUpdateFile(args);
            case 'drive_delete_file': return await driveDeleteFile(args);
            case 'drive_create_folder': return await driveCreateFolder(args);
            case 'drive_move_file': return await driveMoveFile(args);
            case 'drive_get_file_metadata': return await driveGetFileMetadata(args);
            default:
