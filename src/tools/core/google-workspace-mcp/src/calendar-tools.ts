...
export async function calendarListEvents(args: { calendarId: string, timeMin?: string, timeMax?: string, maxResults?: number }) {
  const params: any = { 
...
export async function calendarGetEvent(args: { calendarId: string, eventId: string }) {
  const params = { calendarId: args.calendarId, eventId: args.eventId };
...
export async function calendarDeleteEvent(args: { calendarId: string, eventId: string }) {
  const params = { calendarId: args.calendarId, eventId: args.eventId };
